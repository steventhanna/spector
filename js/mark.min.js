...
! function(a, b, c) {
  "function" == typeof define && define.amd ? define([], function() {
    return a(b, c)
  }) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = a(b, c) : a(b, c)
}(function(a, b) {
  var c = function() {
      function c(b) {
      ...
      return _createClass(c, [{
        ...
        key: "matchesExclude",
        value: function(a) {
          return d.matches(a, this.opt.exclude.concat(["script", "style", "title", "head", "html"]))
        }
      }, {
          ...
          a.nodes.every(function(g, h) {
            ...
            if ("undefined" == typeof i || i.start > b) {
              var j = function() {
                ...
                return g.node = f.wrapRangeInTextNode(g.node, i, j), a.value = k + l, a.nodes.forEach(function(b, c) {
                  c >= h && (a.nodes[c].start > 0 && c !== h && (a.nodes[c].start -= j), a.nodes[c].end -= j)
                }), c -= j, e(g.node.previousSibling, g.start), c > g.end ? void(b = g.end) : {
                  v: !1
                }
              }();
        ...
        key: "iterator",
        get: function() {
          return this._iterator || (this._iterator = new d(this.ctx, this.opt.iframes, this.opt.exclude, this.opt.iframesTimeout)), this._iterator
        }
      }]), c
    }(),
    d = function() {
